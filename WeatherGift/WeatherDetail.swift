...
//  WeatherGift
//
//  Created by Daniel Kurtyka on 3/26/18.
...
class WeatherLocation {
    ...
    var currentTime = 0.0
    var timeZone = ""
    var hourlyForecastArray =  [HourlyForecasst]()
        ...
        Alamofire.request(weatherURL).responseJSON { response in
            ...
            case .success(let value):
                ...
                for hour in 1...hourlyDataArray.count-1 {
                    ...
                    let newHourlyForecast = HourlyForecasst(hourlyTime: hourlyTime, hourlyTemperature: hourlyTemperature, hourlyPrecipProb: hourlyPrecipProb, hourlyIcon: hourlyIcon)
